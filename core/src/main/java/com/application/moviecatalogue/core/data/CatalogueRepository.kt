...
import com.application.moviecatalogue.core.utlis.AppExecutors
import com.application.moviecatalogue.core.utlis.DataMapper
...
class CatalogueRepository @Inject constructor(
    ...
    override fun setFavTvShow(tvShow: TvShow, state: Boolean) {
